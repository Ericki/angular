<?php
	...
	class API extends REST {
		...
		const DB_SERVER = "93.188.162.252";
		const DB_USER = "root";
		const DB_PASSWORD = "trabajoterminal2";
		...
		*/
		...
		private function customers(){	
			...
			$query="SELECT distinct c.customerNumber FROM angularcode_customers c order by c.customerNumber desc";
			$r = $this->mysqli->query($query) or die($this->mysqli->error.__LINE__);
